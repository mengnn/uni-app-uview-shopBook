<template>
	<view class="u-wrap">
		<view class="u-search-box">
			<u-search placeholder="输入关键字" v-model="keyword" @custom="searchGoods" @clear="clearGoods"></u-search>
		</view>
				...
				<view class="page-view">
					<view class="class-item">
						...
						<view class="item-container">
							<navigator :url="'/pages/goods/show?id=' + goods.id" class="thumb-box" v-for="(goods, gi) in goodsList" :key="goods.id">
...
<script>
	import {goodsList} from '@/config/api.js';
	export default {
		data() {
			return {
		...
		methods: {
			...
			async getData(){
				...
				const goodsListRes = await goodsList(params)
				this.categories = goodsListRes.categories
				this.goodsList = [...this.goodsList,...goodsListRes.goods.data]
				this.lastPage = goodsListRes.goods.next_page_url? false : true
				console.log(goodsListRes)
			},
